 ...
 */
// 获取充值渠道二维码
export const getQrCodeImage = (data) => {
  return fetch({
    type: 'post',
    api: '/capital/capitalBase/newQueryQrCode',
    params: data
  })
}
...
// 新增货币地址
export const addBtcAddress = (data) => {
  return fetch({
    type: 'post',
    api: '/user/dc/addDcAddress',
    params: data
  })
}

// 用户货币地址列表
export const getBtcAddressList = () => {
  return fetch({
    type: 'post',
    api: '/user/dc/currency/address'
  })
}

// 解绑货币地址
export const deleteBtcAddress = (data) => {
  return fetch({
    type: 'post',
    api: '/user/dc/delete/currency/address',
    params: data
  })
}

// 修改货币地址
export const updateBtcAddress = (data) =>{
  return fetch({
    type: 'post',
    api: '/user/dc/update/currency/address',
    params: data
  })
}

// 获取货币地址 修改 删除 按钮状态
export const upDeBtnStatus = () => {
  return fetch({
    type: 'post',
    api: '/user/dc/status/query'
  })
}

// gti 电子游戏
// 查询账户是否存在
export const gticheckAccountInfo = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/checkAccountInfo',
    params: data
  })
}

// 创建gti账户
export const gticreateAccountInfo = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/createAccountInfo',
    params: data
  })
}

// 查询gti账户余额
export const gtigetBalance = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/getBalance',
    params: data
  })
}

// 充值gti账户
export const gtirecharge = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/recharge',
    params: data
  })
}

// 从gti账户取款
export const gtiwithDraw = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/withDraw',
    params: data
  })
}

// 进入gti游戏
export const gtiautoGtilogin = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/gti/autoGtilogin',
    params: data
  })
}

// 自动登录 ysb 易博体育游戏
export const ysbautoGtilogin = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ysbUserLogin',
    params: data
  })
}

// ysb 账户查询
export const ysbCheck = () => {
  return fetch({
    type: 'post',
    api: '/thirdCompanies/ysbUserQuery'
  })
}

// ysb 查询余额
export const ysbgetBalance = () => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ysb/getBalance'
  })
}

// ysb 充值
export const ysbrecharge = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ysb/deposit',
    params: data
  })
}

// ysb 提现到余额
export const ysbwithDraw = (data) => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ysb/withDraw',
    params: data
  })
}

// 充值提示
export const getRechargePrompt = (data) => {
  return fetch({
    type: 'post',
    api: '/capital/recharge/queryPersonalTransferNotes',
    params: data
  })
}
...
// ds 德胜棋牌游戏
// 进入 ds 游戏
export const dsLoginGame = () => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ds/login'
  })
}

// 获取 ds 余额
export const getDsBanlance = () => {
  return fetch({
    type: 'get',
    api: '/thirdCompanies/ds/getDsUser'
  })
}

// ds 充值
export const dsRecharge = (data) => {
  return fetch({
    api: '/thirdCompanies/ds/recharge',
    type: 'get',
    params: data
  })
}
...
// ds 提现
export const dsWithdraw = (data) => {
  return fetch({
    api: '/thirdCompanies/ds/withDraw',
    type: 'get',
    params: data
  })
}
...
// 用户绑定手机号，
export const bindSaftyInfo = (data) => {
  return fetch({
    api: '/user/bindSaftyInfo',
    type: 'post',
    params: data
  })
}
